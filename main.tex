...
\begin{enumerate}
    ...
    \begin{itemize}
        \item A. CPU, B. Motherboard, E. RAM
    \end{itemize}
...
the following is the most likely cause?
    \begin{itemize}
        \item D. The lithium battery needs to be replaced.
    \end{itemize}
     \item Which type of adapter card is normally plugged into a PCIe x16
adapter card slot?
    \begin{itemize}
...
several times and fail during boot?
    ...
    \begin{itemize}
        \item D. Perform a full data backup.
    \end{itemize}
...
netic interference (EMI)? (Select the two best answers.)
    \begin{itemize}
        \item B. STP, C. Fiber Optic
    \end{itemize}
    \item You are configuring Bob’s computer to access the Internet. Which
of the following are required? (Select all that apply.)
    \begin{itemize}
        \item A. DNS server address, B. Gateway address
    \end{itemize}
